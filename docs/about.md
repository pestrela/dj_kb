...
My biggest **Laptop** reason is not having to manage **USB sticks**. It also has much more more features than standalone gear.  
My biggest **DDJ-1000** reason is **big jogwheels**.  
My biggest **Traktor** reason is using my **OS folders** as playlists. I also use the preview player, FXs, mapping, strong sync and hotcues.
...
Question #2:  
How could happen that Traktor/NI dropped the jogwheel in 2014 with the S8/remix decks, but in 2021 is still the ONLY major software without flexible beatgrids?
